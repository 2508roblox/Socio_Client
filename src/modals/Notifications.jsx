...
export const Notifications = () => {
    ...
    return (
        <div className={`${isDarkMode ? 'dark' : ''}`}>
            ...
            <button onClick={() => {
                setIsOpen(prev => !prev)
            }} id="dropdownNotificationButton" data-dropdown-toggle="dropdownNotification" class="relative inline-flex items-center text-sm font-medium text-center text-gray-500 hover:text-gray-900 focus:outline-none dark:hover:text-white dark:text-gray-400" type="button">
            ...
            {isOpen && <div id="dropdownNotification" class="z-20 block absolute right-10 top-[2rem] w-full max-w-sm bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-bgmdark dark:divide-gray-700 " aria-labelledby="dropdownNotificationButton">
                <div class="block px-4 py-2 font-medium text-center text-gray-700 rounded-t-lg bg-gray-50 dark:bg-bgmdark dark:text-white">
                    Notifications
                </div>
                <div class="divide-y divide-gray-100 dark:divide-gray-700">
                    <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
                        <div class="flex-shrink-0">
                            ...
                            <div class="absolute flex items-center justify-center w-5 h-5 ml-6 -mt-5 bg-bg border border-white rounded-full dark:border-gray-800">
