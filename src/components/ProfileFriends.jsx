...
export const ProfileFriends = () => {
    ...
    return (
        <div className={`${isDarkMode ? 'dark' : ''} shadow-lg`}>
            <section className="py-6 bg-bgmlight rounded-xl dark:bg-bgmdark dark:text-gray-100">
                <div className="container p-4 mx-auto space-y-16 sm:p-10">
                    <div className="space-y-4">
                        <h3 className="text-2xl font-bold leading-none sm:text-5xl">Friends</h3>
                        <p className="max-w-2xl dark:text-gray-400">102 Friends</p>
                    </div>
